<?php 
    ...
    if($_FILES["image"]["error"] === 4) {
        ...
        if (!in_array($image_extension, $valid_image_extension)) {
            ...
            $query = "INSERT INTO agrovet.product_test(`product_name`, `sale_price`, `measurement_unit`, `volume`, `description`, `indication`, `mode of use`, `brand`, `formula`, `grace_period`, `image_path`)  values('$nome', '$preco', '$unidade', '$volume', '$descricao', '$indicacao', '$modo', '$fabricante', '$formula', '$carencia','$new_image_name')";
